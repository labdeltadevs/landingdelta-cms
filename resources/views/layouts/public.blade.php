            ...
            <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                    ...
                    <ul class="mt-2 space-y-1 text-xs text-zinc-500">
                        ...
                        <li><a href="{{ route('public.products.index') }}" class="hover:text-zinc-900">Productos</a>
                        </li>
                ...
                <div>
                    <h3 class="text-sm font-semibold text-zinc-900">Redes</h3>
                    @php
                        $socialActive = false;
                        $socialIcons = [
                            'linkedin' =>
                            ...
                            @if ($socialUrl)
                                ...
                                <a href="{{ $socialUrl }}" target="_blank" rel="noopener noreferrer" aria-label="{{ ucfirst($key) }}"
                                    class="flex h-8 w-8 items-center justify-center rounded-lg bg-zinc-200 text-zinc-600 transition-all duration-200 hover:scale-110 hover:text-white
                                              ...
                                              {{ $key === 'instagram' ? 'hover:bg-[#E4405F]' : '' }}
                                              {{ $key === 'tiktok' ? 'hover:bg-[#000000]' : '' }}">
                                    {!! $svg !!}
                                </a>
                            @endif
                        @endforeach
                        @if (!$socialActive)
                            <p class="text-xs text-zinc-500">Síguenos para estar al día.</p>
                        @endif
                    </div>
                </div>
            </div>

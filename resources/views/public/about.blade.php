<x-layouts::public
    ...
    @php
        ...
        $valueIcons = [
            [
                'name' => 'Honradez',
                'icon' => 'shield-check',
                'desc' => 'Actuamos con transparencia y ética en cada decisión.',
            ],
            [
                'name' => 'Consideración',
                'icon' => 'heart',
                'desc' => 'Respetamos y valoramos a cada persona que nos rodea.',
            ],
            [
                'name' => 'Trabajo en equipo',
                'icon' => 'users',
                'desc' => 'Juntos logramos más, sumando talentos y esfuerzos.',
            ],
            [
                'name' => 'Responsabilidad',
                'icon' => 'clipboard-check',
                'desc' => 'Cumplimos nuestros compromisos con excelencia.',
            ],
            [
                'name' => 'Mejora continua',
                'icon' => 'arrow-trending-up',
                'desc' => 'Buscamos ser mejores cada día, innovando sin cesar.',
            ],
            [
                'name' => 'Compromiso social',
                'icon' => 'globe-alt',
                'desc' => 'Devolvemos a la sociedad el apoyo que nos brinda.',
            ],
        ];
    @endphp
    ...
    <section
        ...
        {{-- Orbs --}}
        <div class="absolute -top-48 -right-48 h-[35rem] w-[35rem] rounded-full bg-[#ff671f]/8 blur-3xl animate-pulse">
        </div>
        <div class="absolute -bottom-48 -left-48 h-[30rem] w-[30rem] rounded-full bg-[#ff671f]/5 blur-3xl"></div>
        <div
            class="absolute top-1/4 left-1/3 h-1 w-1 rounded-full bg-white/10 shadow-[0_0_80px_40px_rgba(255,103,31,0.08)]">
        </div>
        ...
        <div class="relative z-10 mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8 py-24">
            <div class="text-center" data-aos="fade-up">
                ...
                <h1 class="text-5xl sm:text-6xl lg:text-7xl font-bold leading-[1.05] tracking-tight">
                    ...
                    <span class="text-[#ff671f] relative inline-block">
                        historia
                        <svg class="absolute -bottom-3 left-0 w-full h-4 text-[#ff671f]/20" viewBox="0 0 200 14"
                ...
                {{-- Subtitle --}}
                <p class="mt-6 text-lg sm:text-xl text-zinc-800 max-w-2xl mx-auto leading-relaxed font-light">
                    Una historia de compromiso, calidad y dedicación que comenzó hace más de
                    <strong class="text-[#ff671f] font-semibold">{{ $yearsActive }} años</strong>
            ...
            <div class="mt-20 flex justify-center" data-aos="fade-up" data-aos-delay="300">
                <a href="#travesia"
                    class="flex flex-col items-center gap-2 text-zinc-500 hover:text-zinc-300 transition-colors group">
                    <span class="text-[10px] font-medium uppercase tracking-[0.25em]">Descubre más</span>
                    <span
                        class="flex h-9 w-6 items-start justify-center rounded-full border border-zinc-500 group-hover:border-zinc-300 transition-colors">
                        <span
                            class="mt-1.5 h-2 w-1 rounded-full bg-zinc-500 group-hover:bg-zinc-300 animate-bounce"></span>
                    </span>
                </a>
            </div>
        </div>
    ...
    @if ($hasMilestones)
        <section id="travesia"
            class="relative z-20 isolate py-16 sm:py-20 bg-gradient-to-b from-zinc-50 via-white to-zinc-50/80">
            {{-- Modern mesh gradient bg --}}
            <div class="absolute inset-0 bg-gradient-to-br from-[#ff671f]/4 via-transparent via-40% to-blue-500/5 pointer-events-none"></div>
            {{-- Vibrant animated orbs --}}
            <div class="absolute -top-48 -right-48 h-[35rem] w-[35rem] rounded-full bg-gradient-to-br from-[#ff671f]/10 to-purple-500/10 blur-3xl animate-pulse pointer-events-none" style="animation-duration: 8s;"></div>
            <div class="absolute -bottom-48 -left-48 h-[30rem] w-[30rem] rounded-full bg-gradient-to-tr from-blue-500/8 to-[#ff671f]/5 blur-3xl pointer-events-none"></div>
            <div class="absolute top-1/3 -left-24 h-64 w-64 rounded-full bg-pink-500/5 blur-3xl pointer-events-none"></div>
            {{-- Dot grid --}}
            <div class="absolute inset-0 opacity-[0.012] pointer-events-none"
            ...
            <div class="absolute top-16 right-16 h-28 w-48 rounded-2xl bg-white/20 backdrop-blur-xl border border-white/10 shadow-xl pointer-events-none hidden lg:block"></div>
            <div class="absolute bottom-24 left-16 h-20 w-36 rounded-2xl bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg border border-white/5 shadow-lg pointer-events-none hidden lg:block"></div>
            ...
            <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center" data-aos="fade-up">
                    ...
                    <p class="mt-3 text-sm text-zinc-400 max-w-lg mx-auto">Hitos que marcaron nuestro camino y nos
                        impulsan hacia el futuro.</p>
                </div>
                ...
                <div class="relative mt-16 sm:mt-20">
                    ...
                    <div class="text-center mb-12" data-aos="fade-up">
                        <span class="inline-flex items-center gap-2.5 text-[10px] font-bold uppercase tracking-[0.2em] text-[#ff671f]">
                            <span class="h-px w-8 bg-[#ff671f]/30"></span>
                            Desplázate para descubrir
                            <span class="h-px w-8 bg-[#ff671f]/30"></span>
                        </span>
                        <p class="mt-2 text-sm text-zinc-400">Cada hito marcó un antes y un después en nuestra historia.</p>
                    </div>
                    ...
                    {{-- Central spine line --}}
                    <div class="absolute left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-[#ff671f]/20 via-20% to-transparent hidden sm:block pointer-events-none"></div>
                    ...
                    <div class="relative space-y-16 sm:space-y-24">
                        @foreach ($milestones as $i => $m)
                            @php
                                ...
                                $iconSvg = $iconSvgs[$m['icon'] ?? ''] ?? $iconSvgs['calendar'];
                            @endphp
                            ...
                            <div class="relative flex flex-col sm:flex-row items-center gap-6 sm:gap-8"
                                ...
                                <div class="w-full sm:w-1/2 {{ $isLeft ? 'sm:pr-8 sm:text-right' : 'sm:pl-8 sm:order-2' }}">
                                    <div class="relative bg-white/70 backdrop-blur-xl border border-white/20 shadow-xl shadow-black/5 rounded-2xl transition-all duration-500 hover:shadow-2xl hover:shadow-[#ff671f]/5 hover:border-white/30 hover:-translate-y-1 group">
                                        ...
                                        <div class="relative p-5 sm:p-6">
                                            ...
                                            <div class="flex items-start gap-4 {{ $isLeft ? 'sm:flex-row-reverse sm:text-right' : '' }}">
                                                <div class="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[#ff671f] to-[#e55a1a] text-white shadow-lg shadow-[#ff671f]/20 ring-1 ring-white/20 transition-transform duration-300 group-hover:scale-110">
                                                    {!! $iconSvg !!}
                                                </div>
                                                <div class="flex-1 min-w-0">
                                                    <span class="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-[#ff671f]/10 to-[#ff671f]/5 px-3 py-1 text-[11px] font-semibold text-[#ff671f] tabular-nums ring-1 ring-[#ff671f]/10 mb-1.5">
                                                        <span class="h-1.5 w-1.5 rounded-full bg-[#ff671f]"></span>
                                                        {{ $m['year'] }}
                                                    </span>
                                                    <h3 class="text-base sm:text-lg font-bold text-zinc-800 leading-tight">
                                                        {{ $m['title'] }}
                                                    </h3>
                                                </div>
                                            </div>
                                            ...
                                            {{-- Image --}}
                                            @if ($hasImage)
                                                <div class="mt-4 overflow-hidden rounded-xl border border-zinc-100 bg-gradient-to-b from-zinc-50 to-white shadow-sm"
                                                     x-data="{ loaded: true }" x-show="loaded">
                                                    <img src="{{ $m['image'] }}" alt="Hito {{ $m['year'] }} — {{ $m['title'] }}"
                                                         loading="lazy" class="w-full h-28 sm:h-32 object-cover transition-transform duration-500 group-hover:scale-105"
                                                         @@error="loaded = false">
                                                </div>
                                            @endif
                                        </div>
                                ...
                                {{-- Central node connector (desktop only) --}}
                                <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 hidden sm:flex items-center justify-center">
                                    <div class="relative">
                                        <div class="h-5 w-5 rounded-full bg-gradient-to-br from-[#ff671f] to-[#e55a1a] ring-[5px] ring-white shadow-xl shadow-[#ff671f]/20"></div>
                                        <div class="absolute inset-0 rounded-full animate-ping bg-[#ff671f]/15" style="animation-duration: 3s;"></div>
                                    </div>
                                </div>

                                {{-- Spacer for alternating layout --}}
                                <div class="hidden sm:block sm:w-1/2 {{ $isLeft ? 'sm:order-2' : '' }}"></div>
                            </div>
                        @endforeach
                    </div>
                </div>
    ...
    @if ($hasHistory)
        ...
        = --}}
        <section id="historia" class="relative z-0 overflow-hidden">
            ...
            <div
                class="absolute inset-0 bg-gradient-to-b from-[#d4c5a9]/20 via-transparent to-[#c4b494]/30 pointer-events-none">
            </div>

            {{-- Torn edge top --}}
            <div class="absolute -top-1 left-0 right-0 h-8 bg-[#f5f0e8]"
                style="clip-path: polygon(0% 100%, 3% 40%, 7% 70%, 12% 30%, 18% 80%, 22% 20%, 28% 60%, 33% 50%, 38% 85%, 44% 35%, 50% 70%, 55% 25%, 61% 55%, 67% 40%, 72% 75%, 78% 30%, 83% 65%, 88% 45%, 93% 80%, 97% 35%, 100% 60%, 100% 100%, 0% 100%);">
            </div>

            {{-- Stain/age marks --}}
            <div class="absolute top-32 right-16 w-40 h-40 rounded-full bg-[#d4c5a9]/30 blur-2xl pointer-events-none">
            </div>
            <div
                class="absolute bottom-48 left-12 w-56 h-56 rounded-full bg-[#c4b494]/20 blur-3xl pointer-events-none">
            </div>
            <div class="absolute top-1/3 left-1/4 w-3 h-3 rounded-full bg-[#8b7355]/15 blur-sm pointer-events-none">
            </div>
            <div
                class="absolute bottom-1/4 right-1/3 w-4 h-4 rounded-full bg-[#8b7355]/10 blur-sm pointer-events-none">
            </div>

            {{-- Fold/crease effect across the page --}}
            <div
                class="absolute top-1/2 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#c4b494]/40 to-transparent pointer-events-none">
            </div>
            <div class="absolute top-[calc(50%-8px)] left-0 right-0 h-4 bg-gradient-to-b from-transparent via-[#d4c5a9]/10 to-transparent pointer-events-none"
                style="clip-path: polygon(0% 0%, 100% 0%, 97% 100%, 3% 100%);"></div>
            ...
            <div class="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
                ...
                <div class="text-center mb-12" data-aos="fade-up">
                    ...
                    <div class="mb-4">
                        <span
                            class="inline-flex items-center gap-2 px-3 py-1 text-[9px] font-serif uppercase tracking-[0.25em] text-[#8b7355] border border-[#8b7355]/20 rounded-sm bg-[#efe5d5]/30">
                    ...
                    <div class="flex items-center gap-3 justify-center mb-3">
                        ...
                        <span class="text-[10px] font-serif italic text-[#8b7355] tracking-[0.3em]">EDICIÓN
                            HISTÓRICA</span>
                        <span class="block h-[1px] flex-1 max-w-24 bg-[#8b7355]/30"></span>
                    </div>
                    ...
                    {{-- Date line --}}
                    <div
                        class="mt-4 flex items-center gap-4 justify-center text-[10px] sm:text-xs text-[#8b7355] font-serif uppercase tracking-[0.25em]">
                    ...
                    <div class="mt-5 space-y-[2px]">
                        <span
                            class="block h-[3px] bg-gradient-to-r from-transparent via-[#8b7355]/40 to-transparent"></span>
                        <span
                            class="block h-px bg-gradient-to-r from-transparent via-[#8b7355]/20 to-transparent"></span>
                    </div>
                </div>

                {{-- ========== LEAD PARAGRAPH + FOUNDER PHOTO — SIDE BY SIDE ========== --}}
                <div class="mb-14 grid sm:grid-cols-5 gap-8 sm:gap-10" data-aos="fade-up" data-aos-delay="50">
                    {{-- Left column: Lead paragraph (3/5) --}}
                    <div class="sm:col-span-3">
                        <div class="relative h-full flex flex-col justify-center">
                            ...
                            {{-- Decorative divider within the column --}}
                            <div class="mt-6 flex items-center gap-3 sm:hidden">
                                <span class="block h-px flex-1 bg-[#8b7355]/15"></span>
                                <svg class="w-3 h-3 text-[#8b7355]/20" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {{-- Right column: Founder photo (2/5) --}}
                    <div class="sm:col-span-2">
                        <div class="relative mx-auto max-w-xs sm:max-w-none">
                            {{-- Outer frame with shadow and slight rotation --}}
                            <div
                                class="relative -rotate-[1.2deg] sm:-rotate-[1.5deg] transition-transform duration-700 hover:rotate-0 group">
                                {{-- Shadow beneath the photo --}}
                                <div
                                    class="absolute inset-0 translate-x-1 translate-y-1 rounded-sm bg-[#8b7355]/15 blur-[1px]">
                                </div>

                                {{-- Main frame border --}}
                                <div class="relative border-[5px] border-[#e8dcc8] bg-[#e8dcc8] rounded-sm shadow-lg">
                                    {{-- Subtle inner shadow --}}
                                    <div class="absolute inset-0 shadow-inner pointer-events-none z-10"></div>

                                    {{-- The actual photo with sepia and aged effects --}}
                                    <div class="relative overflow-hidden">
                                        {{-- Sepia overlay --}}
                                        <div class="absolute inset-0 bg-[#8b7355]/10 mix-blend-multiply pointer-events-none z-10"
                                            aria-hidden="true"></div>
                                        {{-- Vignette effect --}}
                                        <div class="absolute inset-0 bg-gradient-to-t from-black/25 via-transparent to-black/5 pointer-events-none z-10"
                                            aria-hidden="true"></div>
                                        {{-- Grain overlay --}}
                                        <div class="absolute inset-0 opacity-20 mix-blend-overlay pointer-events-none z-10"
                                            aria-hidden="true"
                                            style="background-image: url('data:image/svg+xml,%3Csvg viewBox=%270 0 400 400%27 xmlns=%27http://www.w3.org/2000/svg%27%3E%3Cfilter id=%27grain%27%3E%3CfeTurbulence type=%27fractalNoise%27 baseFrequency=%270.65%27 numOctaves=%273%27 stitchTiles=%27stitch%27/%3E%3C/filter%3E%3Crect width=%27100%25%27 height=%27100%25%27 filter=%27url(%23grain)%27/%3E%3C/svg%3E');">
                                        </div>
                                        {{-- Light leak / stain marks --}}
                                        <div class="absolute -top-8 -right-8 w-24 h-24 rounded-full bg-[#d4c5a9]/20 blur-xl pointer-events-none z-10"
                                            aria-hidden="true"></div>
                                        <div class="absolute -bottom-6 -left-6 w-20 h-20 rounded-full bg-[#c4b494]/15 blur-xl pointer-events-none z-10"
                                            aria-hidden="true"></div>

                                        {{-- Image --}}
                                        <img src="/storage/foto-drclaros.jpeg"
                                            alt="Dr. Jorge E. Claros Rojas — Fundador de Laboratorios Delta"
                                            class="w-full h-auto object-cover brightness-[0.9] contrast-[1.05]"
                                            style="filter: sepia(0.55) brightness(0.9) contrast(1.05) saturate(0.75);"
                                            loading="lazy">
                                    </div>
                                </div>
                            </div>

                            {{-- Caption under the photo, typewriter-style --}}
                            <div class="mt-3 text-center" data-aos="fade-up" data-aos-delay="100">
                                {{-- Ornamental line --}}
                                <div class="flex items-center gap-3 justify-center mb-1.5">
                                    <span class="block h-px flex-1 max-w-12 bg-[#8b7355]/20"></span>
                                    <svg class="w-2.5 h-2.5 text-[#8b7355]/30" fill="currentColor"
                                        viewBox="0 0 24 24">
                                        <circle cx="12" cy="12" r="2" />
                                    </svg>
                                    <span class="block h-px flex-1 max-w-12 bg-[#8b7355]/20"></span>
                                ...
                                <p
                                    class="font-serif text-[11px] sm:text-xs text-[#8b7355] leading-relaxed tracking-wide">
                                    <strong class="font-bold text-[#6b5b45]">Dr. Jorge E. Claros Rojas</strong>
                                    <span class="block text-[10px] italic opacity-80">
                                        Fundador — 1987
                                    </span>
                                </p>
                            </div>
                ...
                <div class="my-10 flex items-center gap-4 justify-center">
                    ...
                    <svg class="w-6 h-6 text-[#8b7355]/30" fill="none" stroke="currentColor" stroke-width="1"
                        viewBox="0 0 24 24">
                    ...
                    <div class="sm:columns-2 sm:gap-8 sm:space-y-0 space-y-6">
                        @foreach ($historyParagraphs as $idx => $paragraph)
                            ...
                            <div class="break-inside-avoid mb-6 sm:mb-0 sm:pb-6">
                                ...
                                @endphp
                                <p
                                    class="font-serif text-sm sm:text-base text-[#4a4236] leading-[1.85] sm:text-justify text-left hyphens-auto">
                                    @if ($firstChar && preg_match('/\pL/u', $firstChar))
                                        <span
                                            class="font-serif font-bold text-2xl text-[#3a3226]/70 float-left mr-2 leading-none">{{ $firstChar }}</span>
                                    @endif
                    ...
                    <div class="mt-16" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                            @foreach (array_slice($milestones, 0, 8) as $m)
                                <div
                                    class="group relative border border-[#d4c5a9]/40 bg-[#f5f0e8]/60 p-4 text-center transition-all duration-300 hover:bg-[#efe5d5] hover:shadow-sm hover:-translate-y-0.5">
                                    {{-- Decorative corner dots --}}
                                    <span
                                        class="absolute top-1 left-1 w-1 h-1 rounded-full bg-[#8b7355]/20 group-hover:bg-[#8b7355]/40 transition-colors"></span>
                                    <span
                                        class="absolute bottom-1 right-1 w-1 h-1 rounded-full bg-[#8b7355]/20 group-hover:bg-[#8b7355]/40 transition-colors"></span>
                                    {{-- Year --}}
                                    <div class="font-serif text-xl font-bold text-[#3a3226] tabular-nums">
                                        {{ $m['year'] }}</div>
                                    {{-- Separator --}}
                                    <div class="mx-auto my-1.5 w-6 h-px bg-[#8b7355]/20"></div>
                                    {{-- Title --}}
                                    <div
                                        class="font-serif text-[10px] text-[#8b7355] uppercase tracking-wider leading-tight">
                                        {{ $m['title'] }}</div>
                                </div>
                            @endforeach
                        </div>
                ...
                <div class="mt-16 text-center" data-aos="fade-up">
                    ...
                    <div class="relative inline-flex items-center justify-center">
                        ...
                        <div class="relative flex items-center gap-4 rounded-full bg-[#f5f0e8]/80 px-8 py-4">
                            <span
                                class="font-serif text-3xl sm:text-4xl font-bold text-[#3a3226] tabular-nums">{{ $yearsActive }}</span>
                            <div class="text-left">
                                <span
                                    class="block font-serif text-[10px] text-[#8b7355] uppercase tracking-[0.2em] leading-tight">Años
                                    de</span>
                                <span
                                    class="block font-serif text-[10px] text-[#8b7355] uppercase tracking-[0.2em] leading-tight">Trayectoria</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="absolute -bottom-1 left-0 right-0 h-8 bg-[#f5f0e8]"
                style="clip-path: polygon(0% 0%, 3% 60%, 7% 30%, 12% 70%, 18% 20%, 22% 80%, 28% 40%, 33% 60%, 38% 15%, 44% 65%, 50% 35%, 55% 75%, 61% 25%, 67% 55%, 72% 20%, 78% 70%, 83% 40%, 88% 60%, 93% 30%, 97% 65%, 100% 40%, 100% 0%, 0% 0%);">
            </div>
        </section>
    @endif
        ...
        <section class="relative py-24 sm:py-32 bg-white overflow-hidden">
            ...
            <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-14 grid gap-8 sm:grid-cols-2" data-aos="fade-up" data-aos-delay="100">
                    @if ($hasMission)
                        <div
                            class="group relative overflow-hidden rounded-2xl border border-zinc-200/60 bg-gradient-to-br from-white to-zinc-50 p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:border-[#ff671f]/20">
                            <div
                                class="absolute -top-10 -right-10 h-28 w-28 rounded-full bg-[#ff671f]/5 transition-all duration-500 group-hover:scale-[3] group-hover:bg-[#ff671f]/10">
                            </div>
                            <div class="relative">
                                <div
                                    class="flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-[#ff671f] to-[#e55a1a] text-white shadow-lg shadow-[#ff671f]/20 mb-5">
                                ...
                                <p class="mt-3 text-sm sm:text-base text-zinc-600 leading-relaxed">{{ $missionBody }}
                                </p>
                            </div>
                        </div>
                    @endif
                    ...
                    @if ($hasVision)
                        <div
                            ...
                            <div class="relative">
                                ...
                                <p class="mt-3 text-sm sm:text-base text-zinc-600 leading-relaxed">{{ $visionBody }}
                                </p>
                            </div>
                        </div>
                    @endif
                        ...
                        @php
                            $iconSvgs = [
                                ...
                                'users' =>
                                    '<svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z"/></svg>',
                                'clipboard-check' =>
                                    '<svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5.586a1 1 0 0 1 .707.293l5.414 5.414a1 1 0 0 1 .293.707V19a2 2 0 0 1-2 2Z"/></svg>',
                                'arrow-trending-up' =>
                                    '<svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.281m5.94 2.28-2.28 5.941"/></svg>',
                                'globe-alt' =>
                                    '<svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 0 1 7.843 4.582M12 3a8.997 8.997 0 0 0-7.843 4.582m15.686 0A11.953 11.953 0 0 1 12 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0 1 21 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0 1 12 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 0 1 3 12c0-1.605.42-3.113 1.157-4.418"/></svg>',
                            ];
                        @endphp
                        <div
                            class="group relative overflow-hidden rounded-2xl border border-zinc-200/60 bg-white p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-[#ff671f]/15">
                            <div
                                class="absolute inset-0 bg-gradient-to-br from-[#ff671f]/5 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                            </div>
                            <div class="relative flex items-start gap-4">
                                <div
                                    class="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-[#ff671f]/10 text-[#ff671f] transition-all duration-300 group-hover:bg-[#ff671f] group-hover:text-white group-hover:shadow-lg group-hover:shadow-[#ff671f]/20">
                                    {!! $iconSvgs[$v['icon']] ?? '' !!}
                                </div>
                                <div>
                                    <h3
                                        class="text-sm font-semibold text-zinc-900 group-hover:text-[#ff671f] transition-colors">
                                        {{ $v['name'] }}</h3>
    ...
    @if ($hasQuality)
        <section class="relative py-20 sm:py-24 bg-white overflow-hidden">
            ...
            <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                <div class="relative overflow-hidden rounded-3xl border border-zinc-200/60 bg-gradient-to-br from-zinc-50 to-white p-8 sm:p-12 text-center shadow-lg"
                    data-aos="fade-up">
                    ...
                    <div class="relative">
                        <div
                            class="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#ff671f] to-[#e55a1a] text-white shadow-xl shadow-[#ff671f]/20 mb-6">
                        ...
                        <p class="mt-4 text-sm sm:text-base text-zinc-600 leading-relaxed max-w-2xl mx-auto">
                            {{ $qualityBody }}</p>
                    </div>
                </div>
            </div>
        ...
        <section class="relative py-24 sm:py-32 bg-gradient-to-b from-white to-zinc-50 overflow-hidden">
            <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                <div class="text-center" data-aos="fade-up">
                    ...
                    <p class="mt-3 text-sm text-zinc-400 max-w-lg mx-auto">Estamos presentes en las principales
                        ciudades de Bolivia para servirte mejor.</p>
                </div>

                <div class="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3" data-aos="fade-up" data-aos-delay="100">
                    @foreach ($branches as $branch)
                        <div
                            class="group relative overflow-hidden rounded-2xl border border-zinc-200/60 bg-white p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:border-[#ff671f]/20">
                            <div
                                class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#ff671f] via-[#ff671f]/40 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                            </div>
                            <div class="flex items-start gap-4">
                                <div
                                    class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-[#ff671f]/10 text-[#ff671f]">
